...
<required_reading>
@/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/ali/Desktop/Event-AI-Latest/.codex
                  → checks /home/ali/Desktop/Event-AI-Latest/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done
                  → writes to /home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/hooks/
...
@/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

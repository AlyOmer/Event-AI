...
```bash
AUDITOR_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/ali/Desktop/Event-AI-Latest/.codex/agents/gsd-eval-auditor.md for instructions.

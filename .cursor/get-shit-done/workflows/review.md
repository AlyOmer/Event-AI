...
```bash
GEMINI_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.cursor/get-shit-done/bin/gsd-tools.cjs" config-get review.models.gemini --raw 2>/dev/null || true)
CLAUDE_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.cursor/get-shit-done/bin/gsd-tools.cjs" config-get review.models.claude --raw 2>/dev/null || true)
CODEX_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.cursor/get-shit-done/bin/gsd-tools.cjs" config-get review.models.codex --raw 2>/dev/null || true)
OPENCODE_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.cursor/get-shit-done/bin/gsd-tools.cjs" config-get review.models.opencode --raw 2>/dev/null || true)
```
...
Commit:
```bash
node "/home/ali/Desktop/Event-AI-Latest/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: cross-AI review for phase {N}" --files {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>

...
- Usage: Reference from command with `@/home/ali/Desktop/Event-AI-Latest/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/ali/Desktop/Event-AI-Latest/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ali/Desktop/Event-AI-Latest/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
```bash
INIT=$(node "/home/ali/Desktop/Event-AI-Latest/.codebuddy/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/home/ali/Desktop/Event-AI-Latest/.codebuddy/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```

...
```bash
AUDITOR_MODEL=$(node "/home/ali/Desktop/Event-AI-Latest/.qwen/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/ali/Desktop/Event-AI-Latest/.qwen/agents/gsd-eval-auditor.md for instructions.

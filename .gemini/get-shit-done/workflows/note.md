...
- **Global scope**: `/home/ali/Desktop/Event-AI-Latest/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ali/Desktop/Event-AI-Latest/.gemini/notes/`)
...
2. Glob `/home/ali/Desktop/Event-AI-Latest/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/ali/Desktop/Event-AI-Latest/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ali/Desktop/Event-AI-Latest/.gemini/notes/` — works in any directory

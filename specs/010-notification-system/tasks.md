...
- [x] 7.1 Email notifications (SMTP, fire-and-forget)
- [x] 7.2 Notification deduplication by `eventId + userId` (5-min window)
- [x] 7.3 Vendor-side notifications on new booking
- [ ] 7.4 SMS via Pakistani gateway — P3 (deferred)
- [ ] 7.5 Day-before reminder cron — P3 (deferred)
- [x] 7.6 Notification preferences per user — P3

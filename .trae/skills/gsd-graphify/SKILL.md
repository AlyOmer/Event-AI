...
Knowledge graph is disabled. To activate:
  ...
  node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```

...
Intel system is disabled. To activate:
  ...
  node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/ali/Desktop/Event-AI-Latest/.trae/get-shit-done/bin/gsd-tools.cjs intel diff
```
